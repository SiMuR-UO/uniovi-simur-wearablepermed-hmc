...
Welcome to `uniovi-simur-wearablepermed-hmc` contributor's guide.
...
If you experience bugs or general issues with `uniovi-simur-wearablepermed-hmc`, please have a look
...
You can help improve `uniovi-simur-wearablepermed-hmc` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`uniovi-simur-wearablepermed-hmc` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `uniovi-simur-wearablepermed-hmc`'s files. While this mechanism can
...
```
conda create -n uniovi-simur-wearablepermed-hmc python=3 six virtualenv pytest pytest-cov
conda activate uniovi-simur-wearablepermed-hmc
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/uniovi-simur-wearablepermed-hmc.git
...
5. Install [pre-commit]:
   ...
   `uniovi-simur-wearablepermed-hmc` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/uniovi-simur-wearablepermed-hmc
[issue tracker]: https://github.com/<USERNAME>/uniovi-simur-wearablepermed-hmc/issues
